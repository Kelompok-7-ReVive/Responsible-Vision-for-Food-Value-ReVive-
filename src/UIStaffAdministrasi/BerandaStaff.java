...
public class BerandaStaff extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger 
            = java.util.logging.Logger.getLogger(BerandaStaff.class.getName());
    ...
    public BerandaStaff(UserAccount user) {
    ...
    private void initComponents() {
        ...
        BerandaStaff.setBackground(new java.awt.Color(19, 65, 30));
        BerandaStaff.setFont(new java.awt.Font("Poppins", 1, 14)); // NOI18N
        BerandaStaff.setForeground(new java.awt.Color(255, 255, 255));
        BerandaStaff.setText("Beranda");
        BerandaStaff.setBorder(null);
        BerandaStaff.setBorderPainted(false);
        BerandaStaff.setContentAreaFilled(false);
        BerandaStaff.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BerandaStaffActionPerformed(evt);
            }
        });
        ...
        KeluarStaff.setBackground(new java.awt.Color(19, 65, 30));
        KeluarStaff.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        KeluarStaff.setForeground(new java.awt.Color(255, 255, 255));
        KeluarStaff.setText("Keluar");
        KeluarStaff.setBorder(null);
        KeluarStaff.setBorderPainted(false);
        KeluarStaff.setContentAreaFilled(false);
        KeluarStaff.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KeluarStaffActionPerformed(evt);
            }
        });
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new BerandaStaff().setVisible(true));
    }
